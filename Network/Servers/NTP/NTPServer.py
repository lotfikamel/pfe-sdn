            ...
            if len(rlist) != 0:
                ...
                for tempSocket in rlist:
                    ...
                    try:
                        ...
                        data, addr = tempSocket.recvfrom(65000)

                        data = raw(data)

                        packet = IP(_pkt=data) / NTPHeader(_pkt=data)

                        addr = (packet[IP].src, addr[1])

                        recvTimestamp =  system_to_ntp_time(time.time())

                        # print(ctime(recvTimestamp))
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                sendPacket.ref_timestamp = recvTimestamp
                ...
                packet = IP(dst=addr[0]) / UDP(sport=123) / NTPHeader(_pkt=sendPacket.to_data())

                socket.sendto(raw(packet), addr)
